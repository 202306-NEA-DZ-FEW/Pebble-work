...
const EventCardLeft = ({
    ...
    return (
        <>
            <div
                className={`${styles.contai} border relative sm:w-[62vw] sm:h-[16vh] w-[335px] h-[86px] md:w-[466px] md:h-[140px] flex flex-row-reverse items-center justify-center gap-2`}
            >
