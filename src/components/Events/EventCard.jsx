...
const EventCard = () => {
    return (
        <>
            <div
                className={`${styles.container} overflow-hidden w-[335px] h-[86px] xl:w-[816px] xl:h-[210px] sm:w-[466px] sm:h-[140px] flex flex-row items-center justify-center border border-black rounded-[20px] gap-2`}
            >
                <div className={`flex flex-col gap-1 sm:gap-4 items-end `}>
                    ...
                    <div className='flex'>
                        <p>avatars</p>
                        <button
                            className={`w-[52px] bg-blue-400 text-white text-[10px] xl:text-[15px] md:text-[12px] rounded-[4px] h-[16px] xl:w-[127px] xl:h-[41px] sm:w-[72.23px] sm:h-[25.5px]`}
                        >
                            Join
                        </button>
                    </div>
